...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Προβολή - Μήνας</h1>
                        <hr>
                    </div>

                    <!-- SELECT * FROM `data` WHERE MONTH(imerominia) = 11 AND YEAR(imerominia) = 2021 -->
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <form name="choose_month" id="choose_month" method="post">
                              <div class="form-group" style="text-align:center;">
                                <h2>Επιλογή Μήνα:</h2>
                                <select class="form-select" required id="month_id">
                                    <option value="0" selected>Επιλογή Μήνα</option>
                    ...
                    <!-- Show table -->
                    <div class="row">
                        <div class="col" id="data_table" style="overflow-x:auto;"></div>
                    </div>
                </div>
                <!-- /.container-fluid -->
    ...
    <script type="text/javascript">
        function caller(e){
            ...
            var num = document.getElementById("month_id").value;
            if(num == 0){
                alert("Διάλεξε μήνα!");
                e.preventDefault();
            } else {
                ...
                xhttp.open("POST", "getMonthData.php", true);
                xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xhttp.send("m=" + num.toString());
            }
        }
    </script>
